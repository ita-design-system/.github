...
Pour le moment je n'ai pas de meilleure définition :
...
Le framework UI CSS s'appelle **briks.css** et permet de générer des 
...
![Exemple de table de couleurs valide](img/css-colors-requirements-example-1.webp)

Exemple de table de couleurs invalide
![Exemple de table de couleurs invalide](img/css-colors-requirements-example-2-invalid.webp)
